/**
 * Captures the Studio Arun demo hero into public/demo/studio-arun/hero.png
 ...
 *
 * Usage: node scripts/capture-studio-arun.mjs
...
const page = path.join(root, "public", "demo", "studio-arun", "index.html");
const out = path.join(root, "public", "demo", "studio-arun", "hero.png");
