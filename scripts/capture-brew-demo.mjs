/**
 * Captures the Brew & Co. demo hero into public/demo/brew-and-co/hero.png
 * using an installed Chrome/Edge in headless mode. Zero dependencies.
 *
 * Deterministic by design:
 *  - `?no-loader` skips the café preloader
 ...
 *
 * Usage: node scripts/capture-brew-demo.mjs
...
const page = path.join(root, "public", "demo", "brew-and-co", "index.html");
const out = path.join(root, "public", "demo", "brew-and-co", "hero.png");
